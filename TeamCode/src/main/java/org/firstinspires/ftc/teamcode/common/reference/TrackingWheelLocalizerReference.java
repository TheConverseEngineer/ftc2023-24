 ...
 */
@Config
public class TrackingWheelLocalizerReference extends ThreeTrackingWheelLocalizer {
    public static double TICKS_PER_REV = 4096;
    public static double WHEEL_RADIUS = 0.74803; // in
    public static double GEAR_RATIO = 1; // output (wheel) speed / input (encoder) speed

    public static double LATERAL_DISTANCE = 9621.712084620533 * 0.001056876526771654; // in; distance between the left and right wheels
    ...
    public TrackingWheelLocalizerReference(DcMotorEx left, DcMotorEx right, DcMotorEx front, List<Integer> lastTrackingEncPositions, List<Integer> lastTrackingEncVels) {
        super(Arrays.asList(
        ...
        frontEncoder = new Encoder(front);
