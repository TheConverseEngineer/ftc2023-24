...
public final class Repeat extends Action {
    ...
    /** Create a Repeat action, specifying which actions should be repeated, how many times they should
     * be repeated, and what {@link ActionResources} this loop requires
     *
    ...
    /** Create a Repeat action, specifying which actions should be repeated and how many times they should
     * be repeated.
     *
     * @param numIterations     how many times these actions should be repeated
     * @param actionsToRepeat   the actions that should be repeated (note that they will be executed in order)
