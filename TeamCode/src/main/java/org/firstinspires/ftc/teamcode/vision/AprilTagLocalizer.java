...
import org.firstinspires.ftc.teamcode.OdometryAllSectionTest;
...
public class AprilTagLocalizer extends AprilTagProcessorImpl {
    public AprilTagLocalizer(DoubleSupplier heading, double fx, double fy, double cx, double cy, DistanceUnit outputUnitsLength, AngleUnit outputUnitsAngle, AprilTagLibrary tagLibrary, boolean drawAxes, boolean drawCube, boolean drawOutline, boolean drawTagID, TagFamily tagFamily, int threads) {
    ...
    public Object processFrame(Mat input, long captureTimeNanos) {
        ...
        for (AprilTagDetection i : detections) {
            ...
            SimpleVector2d robotPosition = cameraPosition .plus (new SimpleVector2d(X_OFFSET, Y_OFFSET).rotateBy(-heading.getAsDouble()));

            pose.set(robotPosition);
        }
     ...
     */
    public static AprilTagLocalizer generate(DoubleSupplier heading, double fx, double fy, double cx, double cy) {
        AprilTagLocalizer instance = new AprilTagLocalizer(heading,
