...
public class AprilTagTestOpMode extends LinearOpMode {
    ...
    public static int RES_X = 1024;
    public static int RES_Y = 576;
    ...
    private void initAprilTag() {
        ...
        builder.setCameraResolution(new Size(RES_X, RES_Y));
    ...
    private void telemetryAprilTag() {
        ...
        for (AprilTagDetection detection : currentDetections) {
            if (detection.metadata != null) {
                telemetry.addLine(String.format("World XYZ %6.1f %6.1f (inch)", detection.metadata.fieldPosition.get(0), detection.metadata.fieldPosition.get(1)));
