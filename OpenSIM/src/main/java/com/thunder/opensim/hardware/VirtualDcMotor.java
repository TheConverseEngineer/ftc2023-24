...
public class VirtualDcMotor extends VirtualDcMotorSimple implements DcMotor {
    ...
    private MotorConfigurationType configurationType = MotorConfigurationType.getUnspecifiedMotorType();
    ...
    public void resetDeviceConfigurationForOpMode() {
        ...
        this.configurationType = MotorConfigurationType.getUnspecifiedMotorType();
    }

    @Override public MotorConfigurationType getMotorType() { return configurationType; }
    @Override public void setMotorType(MotorConfigurationType motorType) { this.configurationType = motorType; }
